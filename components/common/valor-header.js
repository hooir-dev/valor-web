                    ...
                    <nav className='mt-[111px] yl:mt-[86px] px-[24px] flex justify-between yl:flex-col'>
                        <nav>
                            <div className="h-[632px] py-6 flex-col justify-start items-start gap-4 inline-flex whitespace-nowrap yl:h-[272px] yl:!gap-2">
                                {
                                    menuList.map((x, i) => (
                                        <div key={i+'abc'} className="w-[506px] justify-start items-center gap-2 inline-flex group cursor-pointer">
                                            ...
                                            <div className="text-[#fff] ease-in-out duration-300 group-hover:text-[#f3fd65] text-8xl font-normal font-['Neue Haas Grotesk Display Pro'] leading-[104px] yl:!text-[40px] yl:!leading-[48px]">{x.name}</div>
                                        </div>
                                    ))
                                }
                            </div>
                        ...
                        <nav className='yl:mt-[80px]'>
                            <div className="w-[356px] px-10 yl:!px-[24px] border-l border-white/10 flex-col justify-between items-start inline-flex">
                                <div className="self-stretch h-[264px] flex-col justify-start items-start gap-6 flex">
                                    <div className="self-stretch opacity-30 text-white text-xl font-medium font-['Neue Haas Grotesk Display Pro']">Get in touch</div>
                                    <div className="flex-col justify-start items-start gap-6 flex">
                                        <div className="justify-start items-start gap-4 inline-flex menu-hover">
                                            ...
                                            <div className="text-white text-xl font-medium font-['Neue Haas Grotesk Display Pro']">Phone</div>
                                        </div>
                                        <div className="justify-start items-start gap-4 inline-flex menu-hover">
                                            <div className="w-6 h-6 justify-center items-center flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div className="text-white text-xl font-medium font-['Neue Haas Grotesk Display Pro']">Email</div>
                                        </div>
                                        <div className="justify-start items-start gap-4 inline-flex menu-hover">
                                            <div className="w-6 h-6 justify-center items-center flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div className="text-white text-xl font-medium font-['Neue Haas Grotesk Display Pro']">Linkedin</div>
                                        </div>
                                        <div className="justify-start items-start gap-4 inline-flex menu-hover">
                                            ...
                                            <div className="text-white text-xl font-medium font-['Neue Haas Grotesk Display Pro']">X</div>
                                        </div>
                                        <div className="justify-start items-start gap-4 inline-flex menu-hover">
                                            <div className="w-6 h-6 justify-center items-center flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div className="text-white text-xl font-medium font-['Neue Haas Grotesk Display Pro']">location</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="text-white text-xl font-medium font-['Neue Haas Grotesk Display Pro'] margin-calc">© 2024  Valor</div>
                            </div>
                        </nav>
                    </nav>
                </div>
